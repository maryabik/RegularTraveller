...
function AddNewTrip(){
  ...
  return (
    <div className="content">
      ...
      <label>
       <button className="button3" style= {{ marginLeft: '30px', backgroundColor: 'white', border : '2px solid black',
       padding: '8px 40px', borderRadius: '12px', transitionDuration: '0.1s', textAlign: 'center', fontSize: '15px',  width: '230px'}}>
      ...
      <button className="button button1" style= {{marginTop: '40px', backgroundColor: 'white', border : '2px solid black',
       padding: '10px 35px', borderRadius: '12px', transitionDuration: '0.4s', textAlign: 'center', fontSize: '16px'}}
       onClick={handleClick}>
        Cancel
      </button>
      <button className="button button2" style= {{ marginLeft: '110px', backgroundColor: 'white', border : '2px solid black',
       padding: '10px 35px', borderRadius: '12px', transitionDuration: '0.4s', textAlign: 'center', fontSize: '16px'}}
       onClick={()=>{window.location.href = "/template-details"}}>
        Save
      </button>

      <div className="signoutBtn" onClick={() => logout()}>LOG OUT
      </div>
